...
settings = {
  ...
  "Plots":["ComMinBiasDPhi_acceptedJets_all", "MHTovMET_all", "MET_all","MHT_all","AlphaT_all","JetMultiplicity_all","HT_all","Number_Btags_all","CommonJetPt_all","CommonJetEta_all","Number_Good_verticies_all"],
